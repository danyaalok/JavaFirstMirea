...
public class Main{
    private Student[] FirstArr () {
        ...
        array_1[0] = new Student(3,"Tom",10);
        array_1[1] = new Student(1,"Boris",14);
        array_1[2] = new Student(2, "Ann", 15);
        array_1[3] = new Student(5,"Kate", 7);
        array_1[4] = new Student(4,"John",1);
    ...
    private Student[] SecondArr() {
        ...
        array_2[1] = new Student(8,"Roman",11);
        array_2[2] = new Student(10,"Lisa",17);
        array_2[3] = new Student(6,"Simon",5);
        array_2[4] = new Student(9,"Dan",19);
